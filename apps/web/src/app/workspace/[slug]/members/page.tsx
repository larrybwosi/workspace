    ...
    <div className="h-screen flex overflow-hidden bg-background">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        ...
        <div className="flex flex-1 overflow-hidden relative">
                      ...
                      {generatedLink ? (
                        ...
                        <div className="space-y-4">
                          <p className="text-sm text-muted-foreground">
                            Invite links allow anyone with the link to join your workspace. The link will be associated
                            with you so we know who invited the new member.
                          </p>
                          <div className="space-y-2">
          ...
          <InfoPanel isOpen={infoPanelOpen} onClose={() => setInfoPanelOpen(false)} type="workspace" id={slug} />
        </div>
      </main>
    </div>
  );

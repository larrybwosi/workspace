...
describe('ChannelsService', () => {
  ...
  describe('removeReaction - atomic delete with idempotency', () => {
    ...
    it('should rethrow non-P2025 errors', async () => {
      ...
      await expect(service.removeReaction('ch-1', 'msg-1', 'user-1', '👍')).rejects.toThrow('DB connection failed');
    });
    ...
    it('should rethrow errors without a code property', async () => {
      ...
      await expect(service.removeReaction('ch-1', 'msg-1', 'user-1', '❤️')).rejects.toThrow('Unexpected failure');
    });
  });
});

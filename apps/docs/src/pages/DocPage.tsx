                                  ...
                                  <CardContent className="py-6">
                                    <Tabs defaultValue="params">
                                      ...
                                      <TabsContent value="sdk-react">
                                        <div className="relative group rounded-lg overflow-hidden bg-black/90">
                                          <div className="absolute right-2 top-2">
                                            <CopyButton value={generateReactSnippet(operation, sdkNames, method.toLowerCase() === 'get')} />
                                          </div>
                                          <SyntaxHighlighter
                                            code={generateReactSnippet(operation, sdkNames, method.toLowerCase() === 'get')}
                                            language="typescript"
                                          />
                                        </div>
                                      </TabsContent>
                                      ...
                                      <TabsContent value="sdk-node">
                                        <div className="relative group rounded-lg overflow-hidden bg-black/90">
                                          <div className="absolute right-2 top-2">
                                            <CopyButton value={generateNodeSnippet(operation, sdkNames, method.toLowerCase() === 'get')} />
                                          </div>
                                          <SyntaxHighlighter
                                            code={generateNodeSnippet(operation, sdkNames, method.toLowerCase() === 'get')}
                                            language="typescript"
                                          />
                                        </div>
                                      </TabsContent>

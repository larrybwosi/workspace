 ...
 */
export const m2mControllerGetM2mApplications = (
    orgSlug: string,
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
) => {
      ...
      return customInstance<void>(
      {url: `/api/organizations/${orgSlug}/m2m`, method: 'GET', signal
    },
      options);
    }


export const getM2mControllerGetM2mApplicationsQueryKey = (orgSlug: string,) => {
    return [`/api/organizations/${orgSlug}/m2m`] as const;
    }


export const getM2mControllerGetM2mApplicationsQueryOptions = <TData = Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>, TError = ErrorType<unknown>>(orgSlug: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getM2mControllerGetM2mApplicationsQueryKey(orgSlug);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>> = ({ signal }) => m2mControllerGetM2mApplications(orgSlug, requestOptions, signal);





   return  { queryKey, queryFn, enabled: !!(orgSlug), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>, TError, TData> & { queryKey: QueryKey }
}

export type M2mControllerGetM2mApplicationsQueryResult = NonNullable<Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>>
export type M2mControllerGetM2mApplicationsQueryError = ErrorType<unknown>

/**
 * @summary List M2M applications for an organization
 */
export const useM2mControllerGetM2mApplications = <TData = Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>, TError = ErrorType<unknown>>(
 orgSlug: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof m2mControllerGetM2mApplications>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}

  ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } => {

  const queryOptions = getM2mControllerGetM2mApplicationsQueryOptions(orgSlug,options)
 ...
 */
export const m2mControllerCreateM2mApplication = (
    orgSlug: string,
...
export const getM2mControllerCreateM2mApplicationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof m2mControllerCreateM2mApplication>>, TError,{orgSlug: string;data: BodyType<CreateM2mApplicationDto>}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof m2mControllerCreateM2mApplication>>, TError,{orgSlug: string;data: BodyType<CreateM2mApplicationDto>}, TContext> => {
const {mutation: mutationOptions, request: requestOptions} = options ?? {};




      const mutationFn: MutationFunction<Awaited<ReturnType<typeof m2mControllerCreateM2mApplication>>, {orgSlug: string;data: BodyType<CreateM2mApplicationDto>}> = (props) => {
          const {orgSlug,data} = props ?? {};

          return  m2mControllerCreateM2mApplication(orgSlug,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type M2mControllerCreateM2mApplicationMutationResult = NonNullable<Awaited<ReturnType<typeof m2mControllerCreateM2mApplication>>>
    export type M2mControllerCreateM2mApplicationMutationBody = BodyType<CreateM2mApplicationDto>
    export type M2mControllerCreateM2mApplicationMutationError = ErrorType<unknown>

    /**
 * @summary Create a new M2M application
 */
export const useM2mControllerCreateM2mApplication = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof m2mControllerCreateM2mApplication>>, TError,{orgSlug: string;data: BodyType<CreateM2mApplicationDto>}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationResult<
        Awaited<ReturnType<typeof m2mControllerCreateM2mApplication>>,
        TError,
        {orgSlug: string;data: BodyType<CreateM2mApplicationDto>},
        TContext
      > => {

      const mutationOptions = getM2mControllerCreateM2mApplicationMutationOptions(options);
 ...
 */
export const m2mControllerDeleteM2mApplication = (
    orgSlug: string,
    id: string,
 options?: SecondParameter<typeof customInstance>,) => {
...
export const getM2mControllerDeleteM2mApplicationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof m2mControllerDeleteM2mApplication>>, TError,{orgSlug: string;id: string}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof m2mControllerDeleteM2mApplication>>, TError,{orgSlug: string;id: string}, TContext> => {
const {mutation: mutationOptions, request: requestOptions} = options ?? {};




      const mutationFn: MutationFunction<Awaited<ReturnType<typeof m2mControllerDeleteM2mApplication>>, {orgSlug: string;id: string}> = (props) => {
          const {orgSlug,id} = props ?? {};

          return  m2mControllerDeleteM2mApplication(orgSlug,id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type M2mControllerDeleteM2mApplicationMutationResult = NonNullable<Awaited<ReturnType<typeof m2mControllerDeleteM2mApplication>>>

    export type M2mControllerDeleteM2mApplicationMutationError = ErrorType<unknown>

    /**
 * @summary Delete an M2M application
 */
export const useM2mControllerDeleteM2mApplication = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof m2mControllerDeleteM2mApplication>>, TError,{orgSlug: string;id: string}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationResult<
        Awaited<ReturnType<typeof m2mControllerDeleteM2mApplication>>,
        TError,
        {orgSlug: string;id: string},
        TContext
      > => {

      const mutationOptions = getM2mControllerDeleteM2mApplicationMutationOptions(options);

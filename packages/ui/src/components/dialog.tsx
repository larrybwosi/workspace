  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-xl border border-border bg-card p-6 shadow-2xl shadow-black/10 duration-200 outline-none data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 sm:max-w-lg',
          className
        )}
        {...props}
      >
  ...
  return (
    <div
      ...
      className={cn(
        ...
        bordered && '-mx-6 -mt-6 mb-1 border-b border-border px-6 pt-5 pb-4',
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        bordered && '-mx-6 -mb-6 mt-1 border-t border-border bg-muted/40 px-6 py-4',
        className
      )}
      {...props}
    >

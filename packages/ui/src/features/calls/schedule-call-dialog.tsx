...
export function ScheduleCallDialog({ open, onOpenChange, workspaceSlug, channelId }: ScheduleCallDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Plan a meeting and notify your team.</DialogDescription>
        </DialogHeader>

...
// Local CodeHighlightPlugin to handle code formatting
...
export const LexicalEditor = forwardRef<any, EditorProps>(
  ({ onChange, placeholder, onEnter, initialValue, onMentionSearch, onMentionPosition, onEditorRef }, ref) => {
    const initialConfig = {
      ...
      <LexicalComposer initialConfig={initialConfig}>
        <div className="relative w-full">
          ...
          {onMentionSearch && onMentionPosition && (
            <MentionPlugin onSearchChange={onMentionSearch} onPositionChange={onMentionPosition} />
          )}
          <RefPlugin
